...
"""
Plots the results of .test files generated by VQ and GMM recognizers.
Test files are given as command line arguments.   
"""
...
if __name__ == '__main__':
    ...
    if testInfo[1] == "ver":
        ...
        eerDcf = dp.GetEERandDCF(results)
        dp.PlotDET(results, eerDcf, testInfo[0])
    else:
